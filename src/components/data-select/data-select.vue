            ...
            <view class="uni-select" :class="{ 'uni-select--disabled': disabled }">
                <view class="uni-select__input-box" @click="toggleSelector">
                    <view v-if="current" class="uni-select__input-text">
                        <image class="tabImg" :src="image" style="width: 48rpx;height: 48rpx;" mode="" v-if="image"></image>
                        <view>
                            {{ current }}
                        </view>
                    </view>
                    <view v-else class="uni-select__input-text uni-select__input-placeholder">{{ typePlaceholder }}
                    </view>
                    <view v-if="current && clear && !disabled" @click.stop="clearVal">
                        <uni-icons type="clear" color="#c0c4cc" size="24"></uni-icons>
                    </view>
                    <view v-else>
                        <uni-icons :type="showSelector ? 'top' : 'right'" size="14" color="#999"></uni-icons>
                    </view>
                </view>
                ...
                <view class="uni-select__selector" :style="getOffsetByPlacement" v-if="showSelector">
                    ...
                    <scroll-view scroll-y="true" class="uni-select__selector-scroll">
                        ...
                        <view v-else class="uni-select__selector-item" v-for="(item, index) in mixinDatacomResData"
                            ...
                            <image class="tabImg" :src="item.image" mode="" v-if="item.image"></image>
                            <text :class="{ 'uni-select__selector__disabled': item.disable }">{{ formatItemName(item)
                                }}</text>
                        </view>
                    </scroll-view>
                </view>
