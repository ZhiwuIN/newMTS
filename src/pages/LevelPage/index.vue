			...
			<view class="level_top_bg" :style="topStyle">
				...
				<view class="level_top_bg2">
					<view class="level-arc" :class="{
						...
						<view class="pie0">
							<view class="pieText">
								{{ currentPIndex == 1 ? levelList[levelList.length - 1]?.levelName :
									levelList[currentPIndex - 2]?.levelName}}
							</view>
						</view>
						<view class="pie1">
							<view class="pieText" v-if="!isLeft && !isRight">
								{{ currentPIndex == 0 ? levelList[levelList.length - 1]?.levelName :
									levelList[currentPIndex - 1]?.levelName}}
							</view>
						</view>
						<view class="active">
						</view>
						...
						<view class="pie2">
							<view class="pieText" v-if="!isLeft && !isRight">
								{{ currentPIndex == levelList.length - 1 ? levelList[0]?.levelName :
									levelList[currentPIndex + 1]?.levelName}}
							</view>
						</view>
						<view class="pie3">
