                ...
                <scroll-view scroll-y :refresher-enabled="true" :refresher-triggered="isRefreshing"
                    ...
                    <view class="list-item" v-for="(item, index) in billsList" :key="index">
                        <view class="item-left">
                            <view class="item-left-t1">{{ currency }} {{ item.totalReward }}</view>
                            <view class="item-left-t2">{{ item.orderNo || '' }}</view>
                        </view>
                        <view class="item-right">
                            <view class="item-right-t1">{{ item.createTime }}</view>
                            <view class="item-right-t2">{{ item.recordType }}</view>
                        </view>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            wishTreeRecordListApi(this.page).then((res) => {
                this.loading = false
